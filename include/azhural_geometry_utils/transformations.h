...
geometry_msgs::Transform calculateTransformRelativeToTransform(const geometry_msgs::TransformStamped &origin_to_intermediate, const geometry_msgs::Transform &intermediate_to_target);
